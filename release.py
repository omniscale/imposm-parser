...
PACKAGE_NAME = 'imposm.parser'
REMOTE_DOC_LOCATION = 'omniscale.de:domains/imposm.org/docs/imposm.parser'
...
def upload_sdist_command():
    ...
    sh('scp dist/imposm.parser-%(ver)s.* %(remote_rel_location)s' % locals())
